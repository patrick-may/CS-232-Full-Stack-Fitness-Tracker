...
def test_insert_workout(flask_test_client):
    ...
    # the workout to
    request = flask_test_client.post("/api/v1/members/", json={"name":"Timothy", "age":19, "sex":"M"})
    ...
    workout_json = {"gym_id":timothy_id, "workout_date":"05/24/2022", "duration":48,
        "exercises":[ {"machine_name":"Squat Rack 1", "reps":5, "weight":135}, 
                    {"machine_name":"Pull Up Bar 2", "reps":13, "weight":0},
...
def test_delete_workout(flask_test_client):
    ...
    old_values = json.loads(flask_test_client.get("/api/v1/workouts/").data.decode())
    ...
    new_values = json.loads(flask_test_client.get("/api/v1/workouts/").data.decode())
...
def test_view_workout(flask_test_client):
    ...
    request = flask_test_client.post("/api/v1/members/", json={"name":"Second Member", "age":49, "sex":"F"})
    ...
    workout_json_2 = {"gym_id":2, "workout_date":"05/24/2022", "duration":35,
        "exercises":[ {"machine_name":"Squat Rack 3", "reps":9, "weight":135}, 
                    {"machine_name":"Decline Bench 2", "reps":14, "weight":40},
